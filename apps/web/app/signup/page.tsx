        ...
        <CardContent className="space-y-6 p-6">
          ...
          <div className="space-y-1 text-center">
            ...
            <p className="text-sm text-zinc-400">
              Start sending beautiful invoices in minutes.
            </p>
          </div>
          ...
          <form action={signUp} className="space-y-4">
            ...
            <Button type="submit" className="group mt-2 h-11 w-full rounded-xl bg-white font-medium text-black hover:bg-zinc-200">
              Create account
