    ...
    <section className="flex-1 space-y-8 p-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-zinc-500">
            All invoices · filtered and searchable
          </p>
        </div>
      ...
      <div className="rounded-3xl border border-zinc-200 bg-white shadow-sm">
        <div className="flex items-center justify-between border-b border-zinc-200 p-6">
          ...
          <button className="inline-flex items-center gap-2 rounded-xl border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100">
                    ...
                    >
                      <span
                        className={`h-2 w-2 rounded-full ${
                          statusDots[
                            invoice.status as keyof typeof statusDots
                          ]
                        }`}
                      />
                      {invoice.status}
